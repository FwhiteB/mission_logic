...
def generate_launch_description():
    ...
    default_pipeline_config_file = os.path.join(package_share, 'config', 'straight_wire.json')

    config_file = LaunchConfiguration('config_file')
    pipeline_config_file = LaunchConfiguration('pipeline_config_file')
    ...
    declare_config_file = DeclareLaunchArgument(
        ...
        description='YAML parameter file for mission_node and magnetic_field_node.',
    )
    declare_pipeline_config_file = DeclareLaunchArgument(
        'pipeline_config_file',
        default_value=default_pipeline_config_file,
        description='JSON pipeline configuration for the simulated magnetic field.',
    )
    ...
    declare_magnetic_field_topic = DeclareLaunchArgument(
        ...
        description='Simulated SensorMsg output topic.',
    )
